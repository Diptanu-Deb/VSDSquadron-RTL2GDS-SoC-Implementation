...
| *.hex | Memory initialization image used in simulation |
| *.vvp | Compiled simulation binary generated by Icarus Verilog |
| *.vcd | Waveform dump file used for debugging signals |
| *.lst | Firmware disassembly listing for debugging assembly instructions |
